...
if USE_S3:
    ...
    AWS_S3_KMS_ENCRYPTION_KEY_ID = os.getenv('AWS_S3_KMS_ENCRYPTION_KEY_ID')
    ...
    STATICFILES_STORAGE = 'ops_api.storage_backends.StaticStorage'
    # s3 public media settings
    PUBLIC_MEDIA_LOCATION = 'media'
    MEDIA_URL = f'https://{AWS_S3_CUSTOM_DOMAIN}/{PUBLIC_MEDIA_LOCATION}/'
    DEFAULT_FILE_STORAGE = 'ops_api.storage_backends.PublicMediaStorage'
    # s3 private media settings
    PRIVATE_MEDIA_LOCATION = 'private'
    PRIVATE_FILE_STORAGE = 'ops_api.storage_backends.PrivateMediaStorage'
else:
